                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-links">
                                    <a href="restorePanel.php?id=<?= $row['product_id'] ?>&category=product" onclick="return confirm('Restore this item to active?')" style="color: #009900ff;">↩️ Restore</a>
                ...
                <table>
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <div class="action-links">
                                    <a href="restorePanel.php?id=<?= $row['music_id'] ?>&category=music" onclick="return confirm('Restore this song to active?')" style="color: #009900ff;">↩️ Restore</a>
                                </div>
                            </td>
                        </tr>
                    <?php endwhile; ?>
