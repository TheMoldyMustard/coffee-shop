                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-links">
                                    ...
                                    <a href="archivePanel.php?id=<?= $row['product_id'] ?>&category=product" onclick="return confirm('Archive this item?')" style="color: #c94545;">🗄️ Archive Record</a>
                                </div>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="action-links">
                                    <a href="edit_music.php?id=<?= $row['music_id'] ?>">✏️ Edit</a>
                                    <a href="archivePanel.php?id=<?= $row['music_id'] ?>&category=music" onclick="return confirm('Archive this song?')" style="color: #c94545;">🗑️ Archive</a>
                                </div>
                            </td>
                        </tr>
                    <?php endwhile; ?>
